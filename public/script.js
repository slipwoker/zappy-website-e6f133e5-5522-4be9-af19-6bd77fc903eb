                ...
                fetch(action, options)
                    .then(response => {
                        if (response.ok) {
                            ...
                            successMsg.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; border: 1px solid #28a745; border-radius: 4px;';
                    ...
                    .catch(() => {
                        ...
                        errorMsg.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; border: 1px solid #dc3545; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e6f133e5-5522-4be9-af19-6bd77fc903eb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e6f133e5-5522-4be9-af19-6bd77fc903eb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e6f133e5-5522-4be9-af19-6bd77fc903eb';
